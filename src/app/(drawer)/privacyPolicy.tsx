  ...
  return (
    <ScrollView className="flex-1 bg-white px-5 py-6" showsVerticalScrollIndicator={false}>
      ...
      <Text className="text-black mb-4 text-lg">
        ...
        device or app performance data may be collected automatically to improve
        app performance.
      </Text>

      <Text className="text-lg font-semibold mb-2">2. Content & Copyright</Text>
      <Text className="text-black mb-4 text-lg">
        All materials are for educational purposes only. If you are a copyright
        owner and believe your content has been used without proper permission,
        please contact us for removal or credit.
      </Text>
      ...
      <Text
        ...
        onPress={() => Linking.openURL('mailto:mail.mrengineerdev@gmail.com')}>
